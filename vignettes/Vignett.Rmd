...
The read_NPX function imports an NPX file of wide format that has been exported from Olink® and converts the data into the (preferred by R) long format. The wide format is the most common way Olink® delivers data for Olink® Target 96, however, for data analysis a long format is preferred. No prior alterations to the NPX output file should be made for this function to work as expected.
...
### Function arguments
 ...
 + lod_file_path: Path to fixed LOD file from Olink website. This is only applicable if using the fixed LOD method. 
